...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final ViewbindingpropertydelegateLibraryAccessors laccForViewbindingpropertydelegateLibraryAccessors = new ViewbindingpropertydelegateLibraryAccessors(owner);
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
        ...
        /**
         * Creates a dependency provider for automotivenavigation (com.yandex.mapkit.styling:automotivenavigation)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAutomotivenavigation() {
            return create("automotivenavigation");
    }
        ...
        /**
         * Creates a dependency provider for parent (com.squareup.okhttp3:parent)
         * This dependency was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Creates a dependency provider for roadevents (com.yandex.mapkit.styling:roadevents)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getRoadevents() {
            return create("roadevents");
    }
        ...
        /**
         * Creates a dependency provider for search (com.yandex.android:search)
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    /**
     * Returns the group of libraries at viewbindingpropertydelegate
     */
    public ViewbindingpropertydelegateLibraryAccessors getViewbindingpropertydelegate() {
        return laccForViewbindingpropertydelegateLibraryAccessors;
    }
    ...
    public static class CircleLibraryAccessors extends SubDependencyFactory {
        ...
        public CircleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for view (de.hdodenhof:circleimageview)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getView() {
                return create("circle.view");
        }
    ...
    public static class MapsLibraryAccessors extends SubDependencyFactory {
        ...
        public MapsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for mobile (com.yandex.android:maps.mobile)
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class ViewbindingpropertydelegateLibraryAccessors extends SubDependencyFactory {

        public ViewbindingpropertydelegateLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for full (com.github.kirich1409:viewbindingpropertydelegate-full)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getFull() {
                return create("viewbindingpropertydelegate.full");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final HiltCompilerVersionAccessors vaccForHiltCompilerVersionAccessors = new HiltCompilerVersionAccessors(providers, config);
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: automotivenavigation (4.6.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getAutomotivenavigation() { return getVersion("automotivenavigation"); }
            ...
            /**
             * Returns the version associated to this alias: compiler (5.0.0-rc01)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: daggerCompiler (2.51.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: hiltAndroidCompiler (2.51.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: mapsMobile (4.6.1-navikit)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: parent (3.14.9)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getParent() { return getVersion("parent"); }

            /**
             * Returns the version associated to this alias: roadevents (4.6.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getRoadevents() { return getVersion("roadevents"); }
            ...
            /**
             * Returns the version associated to this alias: search (3.5.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getSearch() { return getVersion("search"); }

            /**
             * Returns the version associated to this alias: security (1.1.0-alpha03)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: viewbindingpropertydelegateFull (1.5.9)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getViewbindingpropertydelegateFull() { return getVersion("viewbindingpropertydelegateFull"); }
        ...
        /**
         * Returns the group of versions at versions.hiltCompiler
         */
        public HiltCompilerVersionAccessors getHiltCompiler() {
            return vaccForHiltCompilerVersionAccessors;
        }
    ...
    public static class HiltAndroidVersionAccessors extends VersionFactory  {

        public HiltAndroidVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: hilt.android.version (2.51.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getVersion() { return getVersion("hilt.android.version"); }

    }

    public static class HiltCompilerVersionAccessors extends VersionFactory  {

        public HiltCompilerVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: hiltCompiler.version (2.51.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getVersion() { return getVersion("hiltCompiler.version"); }
    ...
    public static class RetrofitVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        public Provider<String> asProvider() { return getVersion("retrofit"); }
            ...
            /**
             * Returns the version associated to this alias: retrofit.adapter (2.11.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getAdapter() { return getVersion("retrofit.adapter"); }
    ...
    public static class RoomVersionAccessors extends VersionFactory  {
        ...
        public RoomVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: room.compiler (2.6.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: room.rxjava2 (2.6.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getRxjava2() { return getVersion("room.rxjava2"); }

            /**
             * Returns the version associated to this alias: room.rxjava3 (2.6.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getRxjava3() { return getVersion("room.rxjava3"); }
